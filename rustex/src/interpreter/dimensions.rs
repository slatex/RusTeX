...
impl std::ops::Div for Numeric {
    ...
    fn div(self, rhs: Self) -> Self::Output {
        ...
        match (self,rhs) {
            ...
            (Int(i),Dim(f)) => Int(round_f((i as f64)/(f as f64 / 65536.0))),
            (BigInt(i),Dim(f)) => BigInt(((i as f64)/(f as f64 / 65536.0)).round() as i64),
            (Int(i),Skip(f)) => Int(round_f((i as f64)/(f.base as f64 / 65536.0))),
            (BigInt(i),Skip(f)) => BigInt(((i as f64)/(f.base as f64 / 65536.0)).round() as i64),
